...
Bbot_controller::Bbot_controller(const ros::NodeHandle &nh,
                                   double radius,
                                   double separation)
                                  : nh_(nh)
{
    ...
    vel_sub_ = nh_.subscribe("bbot_controller/cmd_vel", 1000, &Bbot_controller::velCallback, this);
...
void Bbot_controller::velCallback(const geometry_msgs::Twist &msg)
{
